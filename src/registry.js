...
const key = "wskey clientID";
const secret = "wskey secret";

const wskey = new nodeauth.Wskey(key, secret);

const authenticatingInstitutionId = "institution id";
const principalID = "principal id";
const principalIDNS = "principal idns";
const user = new nodeauth.User(authenticatingInstitutionId, principalID, principalIDNS);
const options = {user: user};

const url = 'https://worldcat.org/oclc-config/institution/search?q=local.oclcSymbol:TUC';
